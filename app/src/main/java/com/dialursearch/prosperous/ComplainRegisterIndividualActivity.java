...
public class ComplainRegisterIndividualActivity extends Activity {

    EditText ed1,ed2,ed3,ed4,ed5;

    String mobile,email,area,name,address;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_complain_register_individual);
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(ComplainRegisterIndividualActivity.this,"Processing...",Toast.LENGTH_LONG).show();
                set();
            }
        });
    ...
    class ClassSpinnerArea implements AdapterView.OnItemSelectedListener
    {
        public void onItemSelected(AdapterView<?> parent, View v, int position, long id)
        {
            ...
            if(area.equals("Others"))
            {
                ...
                LayoutInflater li = LayoutInflater.from(ComplainRegisterIndividualActivity.this);
                View promptsView = li.inflate(R.layout.prompts, null);

                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(ComplainRegisterIndividualActivity.this);
        ...
        public void onNothingSelected(AdapterView<?> parent){
            Toast.makeText(ComplainRegisterIndividualActivity.this, "Choose :", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void onBackPressed() {
        if (goBack) {
            Intent intent=new Intent(ComplainRegisterIndividualActivity.this,ComplainRegisterHomeActivity.class);
    ...
    public void set()
    {
        ...
        if(mobile.isEmpty()||email.isEmpty()||area.isEmpty()||address.isEmpty()||name.isEmpty())
        {
            Toast.makeText(ComplainRegisterIndividualActivity.this,"Please fill the form",Toast.LENGTH_SHORT).show();
        }
        else {
    ...
    class SubmitAsyncTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... urls) {
            ...
            list.add(new BasicNameValuePair("institute", "null"));
        ...
        protected void onPostExecute(String result) {
            ...
            builder = new AlertDialog.Builder(ComplainRegisterIndividualActivity.this);
            builder.setTitle("Complain Registed")
                    ...
                    .setPositiveButton("Book Complain", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            editor_I.commit();
                            Intent intent=new Intent(ComplainRegisterIndividualActivity.this,ComplainBookingActivity.class);
                            startActivity(intent);
                            finish();
                        }
                    })
...
//establishing http connection
        ...
        protected void onPostExecute(Boolean result) {
            ...
            ArrayAdapter area = new ArrayAdapter(ComplainRegisterIndividualActivity.this,android.R.layout.simple_spinner_item,area_s);
            area.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
            //Setting the ArrayAdapter data on the Spinner
            spinner.setAdapter(area);
            if (result == false)
                Toast.makeText(ComplainRegisterIndividualActivity.this, "Unable to fetch data from server", Toast.LENGTH_LONG).show();
